...
if (galleryImages) {
    galleryImages.forEach(function(image, index) {
        image.onclick = function() {
            ...
            let getImgUrlPos = getFullImgUrl.split("/assets/realistic/thumbs/");//Careful
            ...
            newImg.setAttribute("src", "assets/realistic/" + setNewImgUrl);//careful
...
function changeImg(changeDir) {
    ...
    newImg.setAttribute("src", "assets/realistic/img" + calcNewImg + ".jpg");//careful
    newImg.setAttribute("id", "current-img");
